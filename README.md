# CMN-C1-016 — CodeGenerationAgent
...
Converts a natural language specification into source code. Language, style guide,
framework constraints, and a test-generation toggle are all expressed inline in the
free-text `input` string and inferred by the LLM — there is no separate structured
configuration channel, and the template carries zero domain assumptions in code.
